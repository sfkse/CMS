...
<div class="content-wrapper">
    ...
    <div class="content mt-2">
        <div class="container-fluid">
            ...
            <div>
                <h4>Hatırlatmalar</h4>
                  <p><small style="color:red"><em>**Yalnızca adli ve diğer kategorisindeki hatırlatmalar
                        ertelenebilir</em></small></p>
            </div>
            <div class="row">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body hatirlatmalar1" style="height: 300px">
                            ...
                            <?php
                                ...
                                } elseif ($_SESSION["user"]["user_role"] == 5 ||$_SESSION["user"]["user_role"] == 6) {
