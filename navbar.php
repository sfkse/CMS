...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed" <?php if ($_SESSION["user"]["user_role"] == 5 ||$_SESSION["user"]["user_role"] == 6) {
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <div class="navbar-nav ml-auto">
                ...
                if (count($id_value2) > 0 && $_SESSION["user"]["user_role"] == 5||$_SESSION["user"]["user_role"] == 6) { ?>
                ...
                <?php }
                if (count($id_value3) > 0 && $_SESSION["user"]["user_role"] == 5||$_SESSION["user"]["user_role"] == 6) { ?>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index" class="brand-link">
                ...
                <div class="brand-container"> <span class="brand-text info font-weight-light">Öz Hukuk Dosya
                        Takip</span></div>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <?php if ($_SESSION["user"]["user_role"] == 5||$_SESSION["user"]["user_role"] == 6) { ?>
